...
class Notifications {
  ...
  static initialize(BuildContext context) async {
    ...
    try {
      ...
      await flutterLocalNotificationsPlugin.initialize(
          initializationSettings, onSelectNotification: showLastMonthAccountStatement);
    }
    catch
    (e){
    throw e;
  ...
  static Future<void> scheduleNotification(
    ...
    var platformChannelSpecifics = notifs.NotificationDetails(android:
    androidSpecifics, iOS:  iOSSpecifics);
